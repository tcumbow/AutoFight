...
AutoFight[GIDEON] = function ()
	...
	elseif TargetIsHostileNpc() and Magicka()>50 and not IHave("Elemental Weapon") then UseAbility(5)
    elseif TargetIsHostileNpc() and IHave("Elemental Weapon") then LightAttack()
	elseif SomeoneCouldUseRegen() and Magicka()>50 then WeaveAbility(2)
    elseif Magicka()>90 and not IHave("Elemental Weapon") then WeaveAbility(5)
